...
public class Fog {
    ...
    public static final int FOG_COLOR = Color.get(210, 85, 130, 200);
    public static final float FOG_DENSITY = 3.0f;  // Scalar for distance
    public static final float FOG_GRADIENT = 3.5f; // How fast to increase
    public static final float FOG_SHIFT = 0.67f;
