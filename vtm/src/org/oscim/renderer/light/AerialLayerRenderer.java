...
public class AerialLayerRenderer extends LayerRenderer {
    private static final Logger log = LoggerFactory.getLogger(AerialLayerRenderer.class);
    ...
    public AerialLayerRenderer(ExtrusionRenderer renderer) {
