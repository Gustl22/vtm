...
public class SimplifyVW {
    ...
    public void simplify(GeometryBuffer geom, float minArea) {
        ...
        for (int i = 2; i < geom.getPointsSize() - 2; i += 2) {
        ...
        Item last = push(geom.getPointsSize() - 2, Float.MAX_VALUE);
        ...
        float[] points = new float[geom.getPointsSize()];
        System.arraycopy(geom.points, 0, points, 0, geom.getPointsSize());
